...
public class ModHardcodedRecipeProvider extends RecipeProvider implements IConditionBuilder {
    private static final TagKey<Item> AK_LOGS = ItemTags.create(ResourceLocation.fromNamespaceAndPath(galaxyunderchaos.MODID, "ak_logs"));
    private static final TagKey<Item> HEART_BERRY_LOGS = ItemTags.create(ResourceLocation.fromNamespaceAndPath(galaxyunderchaos.MODID, "heart_berry_logs"));
    ...
    private void addSmeltingAndBlasting(RecipeOutput recipeOutput, ItemLike input, ItemLike result, String group, float experience, int smeltTime, int blastTime) {
    ...
    private void addStoneBuildingRecipes(RecipeOutput recipeOutput, String namePrefix, ItemLike base, ItemLike pillar, ItemLike stairs, ItemLike slab, ItemLike wall) {
    ...
    private void addWeaponPart(RecipeOutput recipeOutput, ItemLike blade, ItemLike fang, String name) {
    ...
    private void addWeaponPart(RecipeOutput recipeOutput, ItemLike hilt, ItemLike feather, ItemLike hide, ItemLike stick, String name) {
